...
# WM 2026 schedule (host: USA/Canada/Mexico, 48 teams)
_WM2026_STAGES = [
    ("group", pd.Timestamp("2026-06-11"), pd.Timestamp("2026-07-02")),
    ("r32",   pd.Timestamp("2026-07-03"), pd.Timestamp("2026-07-09")),
    ("r16",   pd.Timestamp("2026-07-10"), pd.Timestamp("2026-07-13")),
    ("qf",    pd.Timestamp("2026-07-17"), pd.Timestamp("2026-07-18")),
    ("sf",    pd.Timestamp("2026-07-21"), pd.Timestamp("2026-07-22")),
    ("final", pd.Timestamp("2026-07-26"), pd.Timestamp("2026-07-26")),
]

# UEFA Nations League / EURO stages (approximate)
_EURO2028_STAGES = [
    ("group", pd.Timestamp("2028-06-01"), pd.Timestamp("2028-06-28")),
    ("r16",   pd.Timestamp("2028-06-29"), pd.Timestamp("2028-07-06")),
    ("qf",    pd.Timestamp("2028-07-07"), pd.Timestamp("2028-07-10")),
    ("sf",    pd.Timestamp("2028-07-11"), pd.Timestamp("2028-07-14")),
    ("final", pd.Timestamp("2028-07-18"), pd.Timestamp("2028-07-18")),
]
