...
class PartitionSpec:
    ...
    def __post_init__(self) -> None:
        ...
        if any(rank[left] > rank[right] for (_, left), (_, right) in zip(ordered, ordered[1:])):
...
__all__ = [
    "COMPETITION", "OUTCOME_ORDER", "PartitionSpec", "ResearchReadinessError",
    "STATIC_FEATURE_TIMESTAMP_AUDIT", "audit_feature_timestamps", "build_candidate_artifact_manifest",
    "build_readiness_report", "canonical_season", "evaluate_predictions", "partition_matches",
]
