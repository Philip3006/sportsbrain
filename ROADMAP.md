...
- **Sub-Phasen** (alle ✅ 2026-06-23/24):
  ...
  - **F. CI/Cron + Roll-out** ✅ — `.github/workflows/tennis_scan.yml` von „Wimbledon nur im Juli" auf „ganzjährig 4×/Tag" + workflow_dispatch `all_live`-Input. `scripts/tennis_gate_review.py` parsed Backtest-Markdown und vergleicht gegen Live-Ledger (PROMOTE/DEMOTE/BLACKLIST/KEEP-Empfehlungen pro Kategorie). 11 Tests neu. **Commit pending.**
